...
The replay slice is shuffled rather than ordered by capture time. This is a
deliberate trade: Monday is benign only and accounts for a fifth of the data,
so a chronological replay spends its first quarter with nothing to detect.
Shuffling gives every second of the stream the attack density of the capture as
a whole. Chronological order remains available behind a flag.
